    ...
    public void openLinks() throws Exception {
        ...
        for (WebElement rest : listOfRest) {
            if (rest.getText().equals("Ресторан Пишпек")) {
                WebElement restoranPishpek = driver.findElement(By.xpath("//a[@href='https://dostavka312.kg/garnirygpt/restoran-pishpek']"));
                restoranPishpek.click();

                WebElement textZavtraki = driver.findElement(By.xpath("//a[normalize-space(text())='Завтраки']"));
                System.out.println(textZavtraki.getText());
                ...
                WebElement productContainer = breakfastHeader.findElement(By.xpath("./following-sibling::div[contains(@class, 'product')]"));
                List<WebElement> menuBreakfast = productContainer.findElements(By.xpath(".//div[@class='food-title']/p[@class='product-name']"));
                //System.out.println(menuBreakfast);
                ...
                WebElement productLemonads = lemonadesHeader.findElement(By.xpath("./following-sibling::div[contains(@class, 'product')]"));
                List<WebElement> menuLemonades = productLemonads.findElements(By.xpath(".//div[@class='food-title']/p[@class='product-name']"));
